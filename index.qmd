...
- Advanced Path: &nbsp;&nbsp;&nbsp;&nbsp;&emsp;<span style="color:#2B7492">  {{< bi star-fill >}} {{< bi star-fill >}} </span>
- Challenging Path:&nbsp;&nbsp;&nbsp; &nbsp;&nbsp; <span style="color:#2B7492"> {{< bi star-fill >}} {{< bi star-fill >}} {{< bi star-fill >}} </span>
...
- [Data Inspection](course/chapters/DHP/SimpleDataInspection.qmd)
...
- [Spectroscopy Data Analysis](course/chapters/SpecialAnalysisPlots//Spectroscopy.qmd)
- [Image Data Analysis](course/chapters/SpecialAnalysisPlots/ImageAnalysis.qmd)
