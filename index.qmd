...
- The main focus will be on the libraries `numpy`, `pandas`, `pandas`, `scipy`, `matplotlib` and `seaborn`.
...
- At the end of this course you will be able to find enough resources to dive deeper into Python.
