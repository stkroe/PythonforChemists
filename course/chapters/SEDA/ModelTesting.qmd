...
print(z_scores)
print("Outliers:", data[np.abs(z_scores) > 2))  # Outliers are those with Z-score > 3
```
...
[Data Import and Inspection Example](https://github.com/stkroe/PythonforChemists/blob/main/course/examples/ModelTesting_Example.ipynb)


Or open it in `Google Colab`:

[Data Import and Inspection Example](https://colab.research.google.com/github/stkroe/PythonforChemists/blob/main/course/examples/ModelTesting_Example.ipynb)
