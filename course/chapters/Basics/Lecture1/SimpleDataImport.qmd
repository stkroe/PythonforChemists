...
pyodide:
  packages:
    ...
    - pandas
  resources:
    - "https://github.com/stkroe/PythonforChemists/blob/main/course/data/temperature.csv"
    - "https://github.com/stkroe/PythonforChemists/blob/main/course/data/temperatures_nan.csv"
    - "https://github.com/stkroe/PythonforChemists/blob/main/course/data/temperature.dat"
    - "https://github.com/stkroe/PythonforChemists/blob/main/course/data/temperatures_nan.dat"
