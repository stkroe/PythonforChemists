...
other-links: 
      - text: "Download Code"
        href: "https://raw.githubusercontent.com/stkroe/PythonForChemists/main/course/notebooks/SimplePlots.ipynb"
        icon: "journal"
code-links:
      - text: "Open in Colab"
...
```{python}
fig = plt.figure(figsize=(8,4),dpi=72,layout='constrained', facecolor='lightskyblue')
...
fig, ax = plt.subplots(3,2, figsize=(2,3), dpi=96, sharex=True, sharey=True, constrained_layout=True,gridspec_kw={'hspace': 0.5, 'wspace': 0.5})
...
gs = GridSpec(3, 2, figure=fig, hspace=0.4, wspace=0.1)
