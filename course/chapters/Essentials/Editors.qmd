...
After you installed Python successfully you need an editor for writing your Python programs. Technicallly you could use everything where you can write text, but it is not really purposeful. 
