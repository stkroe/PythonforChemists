...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const pythonQuiz = [
        ...
        },
        {
            ...
            answer: "3", // Correct answer as a string
            type: "input", // Input-based question
        },
        ...
        },
        {
            ...
            answer: [0, 3], // Correct answers as an array
            type: "multiple-choice", // Multiple-choice question
        },
        { 
        ...
        { questions: "What is the natural logarithm function in NumPy?",
            options: [
                "np.log()",
                "np.ln()",
                "np.logarithm()",
    ...
    document.getElementById('submit-quiz').addEventListener('click', function() {
        ...
        pythonQuiz.forEach((q, qIndex) => {
            ...
            if (q.type === "multiple-choice") {
                ...
                const userInput = document.getElementById(`q${qIndex}-input`).value.trim();
                if (!userInput) {
        ...
        pythonQuiz.forEach((q, qIndex) => {
            ...
            if (q.type === "multiple-choice") {
                ...
                quizHTML += `
                    <div class="option">
                        <input type="text" id="q${qIndex}-input" name="q${qIndex}" placeholder="Type your answer here">
                    </div>
                `;
            }
